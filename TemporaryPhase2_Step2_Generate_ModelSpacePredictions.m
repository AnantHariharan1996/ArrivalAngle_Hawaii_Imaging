...
for Period = Periodlist
    ...
    PLUMEPHASE2_Step2b_SetupParameters


    GoodEvtList = load([ '/Users/ananthariharan/Documents/GitHub/ArrivalAngle_Hawaii_Imaging/Stored_ModelSpacePredictions/Phase2_IDLIST_' num2str(Period) 's.txt']);
% Loop over Files
