...
hold(ax(eventnum),"on")
scatter(ax(eventnum),Obs_Xgrid,Obs_Ygrid,20,Obs_Weights./4,'filled')
...
colormap(ax(eventnum),"turbo")
ax(eventnum).CLim = [0 4]./4;
ylabel(barbar,'Weight', 'fontsize',18)
end
end
...
saveas(junk2,[FigFolder num2str(Period) '_sAllWeights.png'])
end
